...
| `bar-widget` | `BarWidget.qml` | A small "Jarvis" status pill in the bar — a pulsing dot colored by the current phase, with a click-to-open popup showing the latest status line and one-click Dismiss/Stop-conversation buttons. |
